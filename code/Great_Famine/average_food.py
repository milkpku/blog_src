...
def plot_bar():
  ...
  data = [go.Bar(x=year, y=avg_food, marker_color='darkorange')]

  layout = go.Layout(
    title='1950-1970年中国人均粮食产量',
    yaxis=dict(
      title='人均粮食产量（吨/人）')
    )
  ...
  plotly.offline.plot(fig, filename='average_food.html', include_plotlyjs=False)
